...
* Write a function to calculate the total duration exceeding a specified threshold, from a list of values, equidsistantly spaced in time
  - What it the name of function?
  - What are the inputs? Types of the inputs?
  - What is the output? Type of the output?
* Create a class to store the details of a physcial quantity
