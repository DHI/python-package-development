...
Classes contain many pieces that can be isolated further, so they’re generally
...
::: {.incremental}
* Fully automated
* Has full control over all the pieces running (fake out external dependencies)
