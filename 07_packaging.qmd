...
We will show how to create a package using `uv`, and how to distribute it on GitHub, PyPI and a private PyPI server.
...
* Store sensitive information, e.g. passwords, in GitHub (not in your repository).
...
* Private packages can be hosted on e.g. Azure Artifacts or Posit Package Manager.
...
4. Dependencies and Continous Integration
