...
* Include information on how to install your package
    ...
    - `pip install pip install https://github.com/DHI/{repo}/archive/main.zip`
...
3. Reference your code in markdown in the docs folder
4. Run `mkdocs serve` to view locally
:::
...
* Once you have a static website, you need s
